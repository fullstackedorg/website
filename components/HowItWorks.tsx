                ...
                <StepRow
                    ...
                    description={
                        <>
                            ...
                            <p>We are currently experiencing issues with the wait time on AppStoreConnect for the macOS app. Until it reaches TestFlight, you can try <a href="https://files.fullstacked.org/fullstacked-v1-1589.zip" className="text-sky-400 hover:underline">downloading the macOS app here</a>.</p>
