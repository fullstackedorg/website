      ...
      <div className="w-full px-5 sm:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3 font-bold text-xl">
            ...
            <span className="text-white/95 tracking-wide">FullStacked</span>
          </div>
          <div className="flex items-center gap-8 font-medium text-sm">
            <a href="#how-it-works" className="hidden sm:block hover:text-sky-400 transition-colors pt-0.5">Get Started</a>
