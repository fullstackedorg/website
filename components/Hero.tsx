        ...
        <section className="container mx-auto px-8 pt-[10rem] sm:pt-[15rem] pb-32 text-center relative animate-fade-in">
            <div className="relative z-10">
                ...
                <p className="text-xl md:text-2xl max-w-[800px] mx-auto mb-14 text-white/70 leading-relaxed font-sans">
                    Skip the server and ship straight to the user. FullStacked is the single environment to run and share JavaScript projects. Build locally, share directly with users, and run everything on-device without any cloud infrastructure.
                </p>
